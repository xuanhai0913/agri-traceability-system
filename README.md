...
| `backend/` | `DATABASE_URL`, RPC URL, `CONTRACT_ADDRESS`, `CONTRACT_STAGE_SCHEMA`, service wallet private key, `PINATA_JWT`, `IPFS_GATEWAY`, `ADMIN_EMAIL`, `ADMIN_PASSWORD`, `JWT_SECRET`, `SEED_DEMO_USERS`, `SEED_DEMO_PRODUCERS`, CORS origin. |
